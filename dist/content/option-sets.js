"use strict";(()=>{function X(e,o){let t;return(...a)=>{clearTimeout(t),t=setTimeout(()=>e(...a),o)}}function I(){let e={};return Xrm.Page.ui.controls.forEach(o=>{let t=o.getName();if(t)try{e[t]=o.getLabel()||t}catch{e[t]=t}}),e}function P(e,o,t){requestAnimationFrame(()=>{let n=e.getBoundingClientRect();e.style.left=n.left+"px",e.style.top=n.top+"px",e.style.right=""});let a=!1,i=0,c=0,d=n=>{if(!a)return;let p=Math.max(0,Math.min(n.clientX-i,window.innerWidth-e.offsetWidth)),r=Math.max(0,Math.min(n.clientY-c,window.innerHeight-e.offsetHeight));e.style.left=p+"px",e.style.top=r+"px"},l=()=>{a=!1,o.style.cursor="move"};o.addEventListener("mousedown",n=>{t.contains(n.target)||(a=!0,i=n.clientX-e.offsetLeft,c=n.clientY-e.offsetTop,o.style.cursor="grabbing",n.preventDefault())}),document.addEventListener("mousemove",d),document.addEventListener("mouseup",l),new MutationObserver((n,p)=>{document.contains(e)||(document.removeEventListener("mousemove",d),document.removeEventListener("mouseup",l),p.disconnect())}).observe(document.body,{childList:!0,subtree:!0})}function A(e){let o=document.createElement("textarea");o.value=e,o.style.cssText="position:fixed;opacity:0;pointer-events:none",document.body.appendChild(o),o.select(),document.execCommand("copy"),document.body.removeChild(o)}function z(e){navigator.clipboard?.writeText?navigator.clipboard.writeText(e).catch(()=>A(e)):A(e)}var O="crm-tools-optionsets-panel",H="crm-tools-optionsets-style";function R(){let e=document.getElementById(O);if(e){e.remove();return}if(typeof Xrm>"u"||!Xrm.Page||!Xrm.Page.ui||!Xrm.Page.data)return;let o=I(),a=[...Xrm.Page.data.entity.attributes.get().filter(i=>i.getAttributeType()==="optionset"||i.getAttributeType()==="multiselectoptionset")].sort((i,c)=>{let d=(o[i.getName()]||i.getName()).toLowerCase(),l=(o[c.getName()]||c.getName()).toLowerCase();return d.localeCompare(l)});D(),W(a,o)}function D(){if(document.getElementById(H))return;let e=document.createElement("style");e.id=H,e.textContent=`
...
#crm-tools-optionsets-panel .cop-options-list li { white-space: nowrap; }
  `,document.head.appendChild(e)}function T(e,o){let t=document.createElement("span");return t.className="cop-copy-val",t.textContent=e,t.title=`Click to copy: ${o}`,t.addEventListener("click",()=>{z(o),t.classList.add("cop-copied"),setTimeout(()=>t.classList.remove("cop-copied"),1200)}),t}function W(e,o){let t=document.createElement("div");t.id=O;let a=document.createElement("div");a.className="cop-header";let i=document.createElement("span");i.className="cop-header-title",i.textContent="\u{1F518} Option Sets";let c=document.createElement("button");c.className="cop-close",c.title="Close",c.textContent="\u2715",c.addEventListener("click",()=>t.remove()),a.appendChild(i),a.appendChild(c),t.appendChild(a),P(t,a,c);let d=Xrm.Page.data.entity.getEntityName(),l=Xrm.Page.data.entity.getId(),n=document.createElement("div");if(n.className="cop-subheader",n.append("Entity: "),n.appendChild(T(d,d)),n.append("  |  ID: "),l){let s=l.replace(/^\{|\}$/g,"");n.appendChild(T(l,s))}else n.append("(new record)");n.append(`  |  ${e.length} option set field(s)`),t.appendChild(n);let p=document.createElement("div");p.className="cop-search";let r=document.createElement("input");r.type="search",r.placeholder="Search by label or schema name\u2026",r.addEventListener("keydown",s=>s.stopPropagation()),r.addEventListener("keyup",s=>s.stopPropagation()),p.appendChild(r),t.appendChild(p);let x=document.createElement("div");x.className="cop-body";let y=document.createElement("table"),k=document.createElement("thead");k.innerHTML="<tr><th>Label</th><th>Schema Name</th><th>Current Value</th><th>All Options</th></tr>",y.appendChild(k);let v=document.createElement("tbody");e.forEach(s=>{let m=s.getName(),f=o[m]||m,g=s.getText?.()??null,C=[];try{C=s.getOptions()}catch{C=[]}let u=document.createElement("tr");u.dataset.searchLabel=f.toLowerCase(),u.dataset.searchSchema=m.toLowerCase();let N=document.createElement("td");N.textContent=f;let M=document.createElement("td");M.textContent=m;let E=document.createElement("td");if(g===null){let h=document.createElement("span");h.className="cop-null",h.textContent="null",E.appendChild(h)}else E.textContent=g;let S=document.createElement("td"),w=document.createElement("ul");w.className="cop-options-list",C.forEach(h=>{let L=document.createElement("li");L.appendChild(T(String(h.value),String(h.value))),L.append(`: ${h.text}`),w.appendChild(L)}),S.appendChild(w),u.appendChild(N),u.appendChild(M),u.appendChild(E),u.appendChild(S),v.appendChild(u)}),y.appendChild(v);let b=document.createElement("div");b.className="cop-no-results",b.textContent="No matching fields.",b.style.display="none",r.addEventListener("input",X(()=>{let s=r.value.toLowerCase().trim(),m=0;v.querySelectorAll("tr").forEach(f=>{let g=!s||f.dataset.searchLabel.includes(s)||f.dataset.searchSchema.includes(s);f.style.display=g?"":"none",g&&m++}),b.style.display=m===0?"":"none"},100)),x.appendChild(y),x.appendChild(b),t.appendChild(x),document.body.appendChild(t),requestAnimationFrame(()=>{let s=y.offsetWidth;t.style.width=Math.min(Math.max(s,420),window.innerWidth*.9)+"px"})}R();})();
